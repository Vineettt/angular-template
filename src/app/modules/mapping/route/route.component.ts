...
export class RouteComponent extends BasePageComponent implements OnInit {
  __displayedColumns = ['endpoint', 'method', 'handler', 'edit'];
  __dataSource = [];
  __columnData = [
  ...
  getTableData() {
    ...
    requestPayloadObject.endpoint = Endpoint.ROUTES;
